...
public class AwsIotTlsConnection extends AwsIotMqttConnection {
    ...
    public AwsIotTlsConnection(AbstractAwsIotClient client, KeyStore keyStore, String keyPassword, SSLSocketFactory factory)
            throws AWSIotException {
        super(client, factory, "ssl://" + client.getClientEndpoint() + ":8883");
    }
